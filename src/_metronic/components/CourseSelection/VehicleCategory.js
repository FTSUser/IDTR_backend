...
//         setAllVehicleCategory(res?.data?.payload?.Question);
//       })
//       .catch((err) => {
...
//   };
  ...
  const getAllVehicleCategory= async () => {
    ...
    await ApiGet("vehicleCategory/getAllVehicleCategory")
      .then((res) => {
        console.log("getallvehiclecategory", res.data.payload.Question);
        setAllVehicleCategory(res?.data?.payload?.Question);
...
//   };
  ...
  const handleDeleteVehicleCategory = async () => {
    await ApiDelete(`vehicleCategory/deleteVehicleCategory/${pid}`)
      .then((res) => {
        handleClose();
        setPid("");
  ...
  const handleAddProduct = async (e) => {
    ...
    await ApiPost("vehicleCategory/addVehicleCategory", VehicleCategory)
      .then((res) => {
        setLoading(false);
  ...
  const handleForUpdateProduct = async (data) => {
    setPid(data._id);
    setProductValues({
        vehicleCategory: data.productName,
    //   price: data.price,
  ...
  const handleUpdateProduct = async () => {
    ...
    await ApiPut(`vehicleCategory/updateVehicleCategory/id=${pid}`, allVehicleCategory)
      .then((res) => {
        setLoading(false);
        setOpenUpdate(false);
        getAllVehicleCategory();
    ...
    <>
          ...
          <div className="p-2 mb-2">
            <div className="row">
              <div className="col-md-7">
                <h3 className="pt-2 pl-2">All Vehicle Category</h3>
              </div>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Footer>
          ...
          <Button variant="danger" onClick={() => handleDeleteVehicleCategory()}>
            Dele
          </Button>
        </Modal.Footer>
      </Modal>
              ...
              <div className="col-lg-9 col-xl-6">
                <div>
                  <input
                    ...
                    onChange={(e) => {
                      setProductValues((cv) => {
                        return { ...cv, vehicleCategory: e.target.value };
                      });
                      setProductError((cv) => {
                        return { ...cv, vehicleCategory: "" };
                      });
                    }}
                    required
                  />
